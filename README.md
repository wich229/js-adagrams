...
### Wave 1
Our first job is to build a hand of 10 letters for the user. To do so, add a method called `Adagrams.drawLetters` in `src/adagrams.js`. This method should have the following properties:
